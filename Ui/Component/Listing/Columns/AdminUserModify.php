...
class AdminUserModify extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['request_id'])) {
                    $url = $this->urlBuilder->getUrl(
                        'admin/user/edit',
                        [
                            'user_id' => (int)$item['admin_user_modify_id']
                        ]
                    );
                    if($item['admin_user_modify_id']) {
                        $item[$this->getData('name')] = $this->helperData->getAdminUserName($item['admin_user_modify_id']);
                    }
                }
            }
        }
